...
השינויים האחרונים שעשיתי:
- יצרתי גיטהאב פרוג'קט מפורט עם כל המשימות שאני צריך לעשות ושכבר עשיתי
- בדקתי את עניין הפריימים לשנייה ולא מצאתי שעון שמתעדכן מהר יותר
- פיצלתי את הפרוצדורות שמטפלות בכדורית לשלושה סטים של פרוצדורות, אחד לכל סוג כדורית
- הוספתי עוד שני סוגי כדוריות עם פונקציונליות שונה
- הוספתי צלילים נוספים

אני מתקדם אחלה, את ערב שישי הקרוב אני אנצל לכמה שעות מלאות של עבודה על המשחק ובתקווה אסיים אותו לגמרי. אני צריך לעשות הרבה פלייטסטינג בשביל לקבוע האם צריך להעלות את הקושי. רשימה מפורטת יותר של מה שהוספתי ואוסיף תוכל למצוא בקישור הבא:
https://github.com/TheGreenGoblin16/assembly-game/projects/1

מה אני צריך לעשות בשבוע הקרוב:
- להוסיף מד מהירות (טקסט או רכיב גרפי)
- לשחק הרבה במשחק, ולהבין אם צריך עוד קושי
- מנגינת סיום
...
השינויים האחרונים שעשיתי:
- הוספתי מד מהירות כמספר כתוב בפינה הימנית עליונה
- העליתי את רמת הקושי בדרך הבאה: ככל שהמשחק מתקדם והורסים יותר לבנים, הסיכוי של כדוריות רעות ליפול גדל ושל כדוריות טובות קטן
- תכנתתי פרוצדורה שמנגנת מנגינות ממערך תווים
- הוספתי מנגינת הפסד
- הוספתי מנגינת ניצחון שהיא גם איסטר אג (כי יחסית קשה לנצח, תמיד יש משהו מעצבן שיכשיל אותך)

בתכל'ס סיימתי את המשחק לגמרי, הוספתי את כל מה שרציתי מההתחלה. יש לי שבוע נוסף אז חשבתי להוסיף קצת פידבק ויזואלי (כלומר אנימציות כאלה) כדי שהמשחק יהיה קצת יותר מעניין ויפה. יש גם איזה באג ששמתי לב אליו וצריך לתקן. יש סרטון חדשה בתיקייה, וכמו שכתבתי לפני שבועיים ולא ראית, כל המשימות שלי כתובות בפירוט בקישור הבא: https://github.com/TheGreenGoblin16/assembly-game/projects/1

מה אני צריך לעשות בשבוע הקרוב:
- לתקן את הבאג של התנגשות הכדור בפינת הלבנים
- להוסיף פידבק ויזואלי למחבט
- אם אספיק, להוסיף פידבק ויזואלי ללבנים

29.3.2022
---

השינויים האחרונים שעשיתי:
 - שיפרתי את התנגשות הכדור עם הלבנים
 - הוספתי פידבק ויזואלי למחבט, כשהכדור פוגע בו הוא משנה צבע לרגע
 - הוספתי פידבק ויזואלי ללבנים, כשהכדור פוגע והורס אותן הן סוג של מתפוגגות

 לאחר שלושה חודשים ושבוע של עבודה על המשחק באסמבלי, ולאחר סיטואציות ייאוש רבות של "למה זה לא עובד ראבקקקקק", סיימתי את המשחק באופן סופי! אני מוכן להצגת המשחקים מחר. אני רק מקווה שמישהו יצליח לנצח במשחק שלי, כי למען האמת מאז שהפכתי אותו ליותר קשה הצלחתי לנצח רק פעם או פעמיים.

 מה אני צריך לעשות בשבוע הקרוב:
 - כלום ושום דבר! אם לא סופרים את תרגיל הבית בקומבי, תרגיל הבית בקורס B, תרגיל הבית במדמ"ח שנראה ארוך ומעצבן אוף, וגם יש לי מחרתיים מבחן בביולוגיה בבית ספר שצריך להתכונן אליו, ושבוע הבא מבחן בפיזיקה, ואז פסח! היי! חופש!!! 
</div>